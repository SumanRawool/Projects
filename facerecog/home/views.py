...
def addStudent(request):
    ...
    if request.POST.get('degree'):
            ...
            savevalue=Profile(first_name=first,middle_name=middle,last_name=last,phone=phone,email=email,date=date,degree=degree,image=image,type=type)
            savevalue.save()
...
def addTeacher(request):
    ...
    if request.method=="POST":
        ...
        #if password1== password2:
            savenewvalue=Profile(first_name=first,middle_name=middle,last_name=last,phone=phone,email=email,date=date,password=password,image=image,type=type)
